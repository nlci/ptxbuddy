...
namespace PtxBuddy
{
    public partial class FrmPtxbuddy : EmbeddedPluginControl
    {
       ...
       // private SpeechRecognitionEngine recognizer;
        ...
        {
            typingIndicatorPanel = new RoundedPanel1(); 
        ...
        private void ChatArea_SizeChanged(object sender, EventArgs e)
        {
            ...
            {
                if (control is RoundedPanel1 chatBubble)
                {
    ...
    public class RoundedPanel1 : FlowLayoutPanel
    {
